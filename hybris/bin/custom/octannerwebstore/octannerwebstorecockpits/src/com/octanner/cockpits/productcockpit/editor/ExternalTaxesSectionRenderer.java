 ...
 *
 */
package com.octanner.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("octannerwebstorecockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("octannerwebstorecockpits.product.externalTaxes"));

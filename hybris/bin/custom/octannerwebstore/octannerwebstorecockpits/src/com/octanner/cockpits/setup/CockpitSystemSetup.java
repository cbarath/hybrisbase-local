 ...
 *
 */
package com.octanner.cockpits.setup;
...
import com.octanner.cockpits.constants.OctannerwebstoreCockpitsConstants;
 ...
 */
@SystemSetup(extension = OctannerwebstoreCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(OctannerwebstoreCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(OctannerwebstoreCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						OctannerwebstoreCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/octannerwebstorecockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}

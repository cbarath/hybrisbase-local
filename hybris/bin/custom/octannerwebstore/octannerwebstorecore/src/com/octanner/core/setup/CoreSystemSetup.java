 ...
 *  
 */
package com.octanner.core.setup;
 ...
 */
@SystemSetup(extension = OctannerwebstoreCoreConstants.EXTENSIONNAME)
public class CoreSystemSetup extends AbstractSystemSetup
{
	...
	{
		importImpexFile(context, "/octannerwebstorecore/import/essential-data.impex");
		importImpexFile(context, "/octannerwebstorecore/import/countries.impex");
		importImpexFile(context, "/octannerwebstorecore/import/delivery-modes.impex");

		importImpexFile(context, "/octannerwebstorecore/import/themes.impex");
	}
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		{
			importImpexFile(context, "/octannerwebstorecore/import/cockpits/cmscockpit/cmscockpit-users.impex");
			importImpexFile(context, "/octannerwebstorecore/import/cockpits/cmscockpit/cmscockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("btgcockpit"))
		{
			importImpexFile(context, "/octannerwebstorecore/import/cockpits/cmscockpit/btgcockpit-users.impex");
			importImpexFile(context, "/octannerwebstorecore/import/cockpits/cmscockpit/btgcockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("productcockpit"))
		{
			importImpexFile(context, "/octannerwebstorecore/import/cockpits/productcockpit/productcockpit-users.impex");
			importImpexFile(context, "/octannerwebstorecore/import/cockpits/productcockpit/productcockpit-access-rights.impex");
			importImpexFile(context, "/octannerwebstorecore/import/cockpits/productcockpit/productcockpit-constraints.impex");
		}

		if (importAccessRights && extensionNames.contains("cscockpit"))
		{
			importImpexFile(context, "/octannerwebstorecore/import/cockpits/cscockpit/cscockpit-users.impex");
			importImpexFile(context, "/octannerwebstorecore/import/cockpits/cscockpit/cscockpit-access-rights.impex");
		}

		if (extensionNames.contains("mcc"))
		{
			importImpexFile(context, "/octannerwebstorecore/import/mcc-sites-links.impex");
		}
	...
	public PerformResult executeCatalogSyncJob(final SystemSetupContext context, final String catalogName)
	{
		...
		importImpexFile(context, "/octannerwebstorecore/import/catalogs-sync.impex", true);
	...
	protected void importProductCatalog(final SystemSetupContext context, final String catalogName)
	{
		...
		importImpexFile(context, "/octannerwebstorecore/import/productCatalogs/" + catalogName + "ProductCatalog/catalog.impex",
				true);
	...
	protected void createAndActivateSolrIndex(final SystemSetupContext context, final String storeName)
	{
		...
		importImpexFile(context, "/octannerwebstorecore/import/stores/" + storeName + "/solr.impex");

		createSolrIndexerCronJobs(storeName + "Index");

		importImpexFile(context, "/octannerwebstorecore/import/stores/" + storeName + "/solrtrigger.impex");
	...
	protected void importContentCatalog(final SystemSetupContext context, final String catalogName)
	{
		...
		importImpexFile(context, "/octannerwebstorecore/import/contentCatalogs/" + catalogName + "ContentCatalog/catalog.impex",
				true);
		importImpexFile(context, "/octannerwebstorecore/import/contentCatalogs/" + catalogName + "ContentCatalog/cms-content.impex",
				false);
		importImpexFile(context, "/octannerwebstorecore/import/contentCatalogs/" + catalogName
	...
	protected void importStore(final SystemSetupContext context, final String storeName)
	{
		...
		importImpexFile(context, "/octannerwebstorecore/import/stores/" + storeName + "/store.impex");
		importImpexFile(context, "/octannerwebstorecore/import/stores/" + storeName + "/site.impex");

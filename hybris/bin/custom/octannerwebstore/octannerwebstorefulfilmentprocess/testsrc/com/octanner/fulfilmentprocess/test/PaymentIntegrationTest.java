...
import com.octanner.fulfilmentprocess.test.actions.TestActionTemp;
...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception //NOPMD
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/octannerwebstorefulfilmentprocess/test/octannerwebstorefulfilmentprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/octannerwebstorefulfilmentprocess/test/octannerwebstorefulfilmentprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/octannerwebstorefulfilmentprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/octannerwebstorefulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/octannerwebstorefulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/octannerwebstorefulfilmentprocess/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/octannerwebstorefulfilmentprocess/test/octannerwebstorefulfilmentprocess-spring-testcleanup.xml"));

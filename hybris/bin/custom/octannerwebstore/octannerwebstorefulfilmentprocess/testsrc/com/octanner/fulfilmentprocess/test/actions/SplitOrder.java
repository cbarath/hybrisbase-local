 ...
 *
 */
package com.octanner.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(OctannerwebstoreFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(OctannerwebstoreFulfilmentProcessConstants.PARENT_PROCESS);

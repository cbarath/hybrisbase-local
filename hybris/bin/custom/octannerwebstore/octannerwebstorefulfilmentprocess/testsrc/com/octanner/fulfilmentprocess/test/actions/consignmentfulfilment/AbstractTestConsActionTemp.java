 ...
 *
 */
package com.octanner.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, OctannerwebstoreFulfilmentProcessConstants.PARENT_PROCESS);

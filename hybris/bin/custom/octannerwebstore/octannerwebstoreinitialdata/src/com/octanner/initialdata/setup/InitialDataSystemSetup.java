 ...
 *  
 */
package com.octanner.initialdata.setup;
...
import com.octanner.initialdata.constants.OctannerwebstoreInitialDataConstants;
 ...
 */
@SystemSetup(extension = OctannerwebstoreInitialDataConstants.EXTENSIONNAME)
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		// importCommonData(context, "octannerwebstoreinitialdata");
		// This would import a standard store: (one basestore, one cmssite, one product catalog, one content catalog)
		// importStoreInitialData(context, "octannerwebstoreinitialdata", "yb2baccelerator", "yb2baccelerator", Collections.singletonList("yb2baccelerator"));

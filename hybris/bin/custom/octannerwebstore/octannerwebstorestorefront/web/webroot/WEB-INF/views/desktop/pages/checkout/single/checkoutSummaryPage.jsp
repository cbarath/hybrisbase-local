...
<template:page pageTitle="${pageTitle}">
	...
	<div id="placeOrder" class="clearfix">
		<form:form action="${placeOrderUrl}" id="placeOrderForm1" commandName="placeOrderForm">
			...
			<!-- KPIT: Put div tags to hide buttons -->
			...
			<div class="terms left">
				<formElement:formCheckbox idKey="Terms1" labelKey="checkout.summary.placeOrder.readTermsAndConditions" 
	...
	<div class="span-24">
		<form:form action="${placeOrderUrl}" id="placeOrderForm2" commandName="placeOrderForm">
			...
			<div class="terms right">
				<formElement:formCheckbox idKey="Terms2" labelKey="checkout.summary.placeOrder.readTermsAndConditions" 
						inputCSS="checkbox-input" labelCSS="checkbox-label" path="termsCheck" mandatory="true" />
			</div>
		</form:form>
	</div>
